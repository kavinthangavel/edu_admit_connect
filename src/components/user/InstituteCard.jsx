    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-xl shadow m-5">
            ...
            <div className="p-5 font-mono">
                <a >
                    <h3 className="mb-2 text-md font-bold tracking-tighter hover:tracking-normal">Sri Krishna College of Technology</h3>
                </a>
                ...
                <Link to="/institute/1" className="inline-flex text-white bg-sky-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                    Explore Institute
