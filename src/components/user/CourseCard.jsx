    ...
    return (
        <div className="w-full flex flex-row bg-white border border-gray-200 rounded-xl shadow m-5">
            <div className="p-5 font-mono">
                ...
                <Link to="/course/1" className="inline-flex text-white bg-sky-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                    Explore Course
