    ...
    return (
        <div className="w-full flex flex-row bg-white border border-gray-200 rounded-xl shadow m-5">
            <div className="p-5 font-mono">
                <a href="#">
                    <h3 className="mb-2 text-md font-bold tracking-tighter hover:tracking-normal">B.Tech (Information Technology)</h3>
                </a>
                <p className="mb-2 font-normal text-gray-700 tracking-tighter">Sri Krishna College of Technology</p>
                ...
                <div className="grid grid-cols-2 justify-center space-x-2 text-sm min-w-md max-w-md">
                    <Link to="/admin/course/1" className="inline-flex justify-center text-white bg-sky-600 hover:bg-sky-800  px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                        View Details
