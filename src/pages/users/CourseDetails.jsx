...
function CourseDetail() {
    ...
    return (
        <div className="bg-sky-200 p-12 min-h-fit">
            <div className="bg-white rounded-xl border border-gray-200 min-w-screen min-h-fit px-32 p-20 font-mono" style={{ marginTop: "5%" }}>
                <div className="col-span-2 flex justify-center items-center" >
                    <div>

                        <div>
                            <h1 className="text-3xl font-bold tracking-tighter mb-1">Bachelor of Engineering (B.Tech) in IT</h1>
...

            {
                ...
                <form className="fixed top-0 left-0 w-full h-full bg-opacity-0 bg-black backdrop-blur-md py-20 pb-36 mt-20 flex justify-center font-mono overflow-auto">
                    <div className="bg-sky-200 border-2 border-black w-[90%] h-fit p-5 rounded-xl flex flex-col items-center">
                        ...
                        <h1 className="text-2xl font-bold mb-3">Enroll</h1>
                        
                        <div className="bg-white w-full p-5 mb-2 rounded-xl flex flex-col space-y-3">
                        
                        <div className="flex flex-col">
                            <label htmlFor="name" className="tracking-tighter text-sm mb-1 pl-0.5">Name</label>
                            <input type="text" id="name" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>
                        
                        <div className="flex flex-col">
                            <label htmlFor="course" className="tracking-tighter text-sm mb-1 pl-0.5">Course</label>
                            <input type="text" id="course" defaultValue="Bachelor of Engineering (B.Tech) in IT" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>

                        <div className="flex flex-col">
                            <label htmlFor="college" className="tracking-tighter text-sm mb-1 pl-0.5">College</label>
                            <input type="text" id="college" defaultValue="Sri Krishna College of Technology" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>

                        <div className="flex flex-col">
                            <label htmlFor="year" className="tracking-tighter text-sm mb-1 pl-0.5">Year</label>
                            <input type="text" id="year" defaultValue="4" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>
                        
                        <div className="flex flex-col">
                            <label htmlFor="10th" className="tracking-tighter text-sm mb-1 pl-0.5">10th %</label>
                            <input type="text" id="10th" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>

                        <div className="flex flex-col">
                            <label htmlFor="12th" className="tracking-tighter text-sm mb-1 pl-0.5">12th %</label>
                            <input type="text" id="12th" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>

                        <div className="flex flex-col">
                            <label htmlFor="fees" className="tracking-tighter text-sm mb-1 pl-0.5">Fees</label>
                            <input type="text" id="fees" defaultValue="Rs.1,30,000" className="b-2 text-sm bg-sky-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>
