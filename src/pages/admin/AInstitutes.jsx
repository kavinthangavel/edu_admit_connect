...
import InstituteCard from "../../components/admin/InstituteCard";

function AInstitutes() {
  ...
  return (
    <div className="bg-sky-200 min-h-screen p-12 font-mono">
      <div className="mb-5 mx-5 flex justify-center">
          <button onClick={openForm} className="bg-green-600  hover:bg-green-800 hover:px-3 text-white p-2 tracking-tighter rounded-lg flex flex-row space-x-2">
      ...
      {
        formVisibility && (
          <form className="fixed top-0 left-0 w-full h-full bg-opacity-0 bg-black backdrop-blur-md py-20 flex justify-center font-mono overflow-auto">
