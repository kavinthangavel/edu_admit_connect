                        ...
                        <div>
                            ...
                            <div className="leading-7 mb-10">
                                ...
                                <div className="grid grid-cols-4">
                                    ...
                                    <a href="mailto:principal.skct.ac.in" className="font-normal grid grid-cols-subgrid col-span-3 underline underline-offset-2 tracking-tighter">principal@skct.ac.in</a>
                                </div>
                                
                                <div className="grid grid-cols-4">
                                    <p className="font-normal tracking-tighter">Contact Number</p>
                                    <a href="tel:294484864684" className="font-normal grid grid-cols-subgrid col-span-3 underline underline-offset-2 tracking-tighter">456461864</a>
                                </div>

                            </div>

                            <Link to="/admin/courses/" className="inline-flex text-white bg-sky-600 hover:bg-sky-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
